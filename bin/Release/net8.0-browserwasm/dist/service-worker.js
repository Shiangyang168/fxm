import { config } from "/package_139d747401475933cace89da4d89a27521820187/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_139d747401475933cace89da4d89a27521820187').then(async function (cache) {
